...
linked to multiple dimensions for analysis.
...
![Expense Types](https://github.com/muhib20/public-sector-data-warehouse-sql-powerbi/blob/main/Docs/sample_dashboard_expense_types.png)

### Top 3 Suppliers Analysis
